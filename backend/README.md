...
Document atomicity OK.
Document file cleanup OK.
...
- Confirm a normal user's upload is visible to that user and admin, but not to another normal user.
- Confirm an admin upload is readable by existing normal users and a normal user created later.
